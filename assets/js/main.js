...
function eliminar(id) {
  ...
  listaCantidadCheck.textContent = `Realizadas: ${numeroTareasCompletadas}`;
}
...
function dibujarLista() {
  ...
  for (let [index, tarea] of tareas.entries()) {
    ...
    itemHtml = `<li>${tarea.id}  ${tarea.descripcion}   ${checkbox}   <a href='#' onclick=eliminar(${index})><img src="./assets/img/descarga.png" alt="eliminar" height="15px" width="15px"></a> </li>`;
